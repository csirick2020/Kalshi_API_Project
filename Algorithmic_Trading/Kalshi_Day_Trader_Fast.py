# Kalshi_Day_Trader_Fast
# Buy sleep time = 1.5 minutes
# Sell sleep time = 30 seconds
# Number of contracts able to be (effectively) traded with these parameters is 20 - 50
...
BUY_SLEEP_TIME = SECONDS_PER_MINUTE * 1.5  # 1.5 minutes
SELL_SLEEP_TIME = SECONDS_PER_MINUTE / 2  # 30 seconds
