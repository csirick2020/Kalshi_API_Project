...
This is a set of two (main) Python programs which use Kalshi's API for automated trading. The project also includes an ROI calculator I built specifically for Kalshi.
